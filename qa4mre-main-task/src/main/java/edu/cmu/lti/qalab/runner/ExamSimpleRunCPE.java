 ...
 * 
 */
public class ExamSimpleRunCPE extends Thread {
	/**
	 * The CPE instance.
	 */
	 ...
	 *            description
	 */
	public ExamSimpleRunCPE(String args[]) throws Exception {
		mStartTime = System.currentTimeMillis();
		if (args.length == 0) {
			args = new String[1];
			args[0] = new String("src/main/resources/ExamCpeDescriptor.xml");
		}
